...
var Vote = function(){
    ...
    var classPrefixFollow= 'button follow btn btn-default';
    var classPrefixFollowed= 'button followed btn btn-success';
    ...
    var callback_favorite = function(object, voteType, data){
        if(data.allowed == "0" && data.success == "0"){
            ...
            object.attr("class", 'btn btn-default button follow');
            ...
            var followed_html = gettext('<div class=" ">Following</div><div class="unfollow">Unfollow</div>');
            object.html(followed_html);
            object.attr("class", 'button followed btn btn-success');
            var fav = getFavoriteNumber();
            var fmts = ngettext('%s follower', '%s followers', data.count);
            fav.text(interpolate(fmts, [data.count]));
...
EditCommentForm.prototype.createDom = function(){
    ...
    this._submit_btn = $('<button class="btn btn-default"></button>');
    this._controlsBox.append(this._submit_btn);
    this._cancel_btn = $('<button class="btn btn-danger"></button>');
